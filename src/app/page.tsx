...
export default async function Home() {
  ...
  return (
    <>
      {/* ── Desktop: FLOW candy-chrome poster + 인생네컷 ──── */}
      <section
      ...
      >
        <PosterFrame className="fourcuts-pop-in" serial="10072026" index="01">
          <div className="hero-stack">
            <LiquidChromeMark mark="kstar" className="lcm-hero lcm-live" starHole />
            <LiquidChromeMark mark="soulcuts" className="lcm-hero-sub lcm-live" />
            <p className="hero-zh">靈魂四格</p>
