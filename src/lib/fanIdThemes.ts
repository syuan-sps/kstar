...
export const FAN_ID_THEMES: Record<FanIdThemeId, FanIdTheme> = {
  ...
  "gothic-cross": { id: "gothic-cross", label: "Gothic", surface: "linear-gradient(145deg,#292a2d,#77736f 45%,#202125)", surfaceColor: "#343538", border: "#d7d0c4", accent: "#9f4c55", text: "#f1eee7", muted: "#c3bdb4", radius: "8px", header: "linear-gradient(90deg,#111214,#3c3a39)", fontClass: "font-serif", stickers: ["/fanid-themes/gothic-cross/cross-01.png", "/fanid-themes/gothic-cross/fleur-01.png", "/fanid-themes/gothic-cross/star-medallion.png"] },
