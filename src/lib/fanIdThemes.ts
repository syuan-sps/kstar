...
export const FAN_ID_THEMES: Record<FanIdThemeId, FanIdTheme> = {
  chrome: { id: "chrome", label: "Chrome", surface: "linear-gradient(150deg,#ededed 0%,#f6f6f6 30%,#eaeaea 55%,#f2f2f2 78%,#e4e4e4 100%)", surfaceColor: "#ededed", border: "#1c1e24", accent: "#56789f", text: "#1c1e24", muted: "#6a6a6a", radius: "16px", header: "linear-gradient(90deg,rgba(18,18,18,.94),rgba(36,36,36,.9))", fontClass: "font-orbitron", stickers: ["/fanid-themes/kawaii/star-chrome.png", "/fanid-themes/monochrome-cute/item-01.png", "/fanid-themes/kawaii/star-outline.png"] },
