...
const RAW_STICKER_COMPOSITIONS = {
  chrome: [
    ...
    { id: "chrome-star-portrait", kind: "star", x: 100, y: 24, size: 14, rotate: 14, zone: "portrait-edge", layer: "over-portrait" },
    { id: "chrome-chain-right", kind: "chain", x: 97, y: 28, size: 11, rotate: 8, zone: "portrait-edge", layer: "over-portrait" },
  ...
  dreamy: [
    ...
    { id: "dreamy-star-portrait", kind: "star", x: 100, y: 24, size: 14, rotate: 12, zone: "portrait-edge", layer: "over-portrait", tone: "translucent" },
    { id: "dreamy-cloud-right", kind: "cloud", x: 95, y: 28, size: 10, rotate: 6, zone: "portrait-edge", layer: "over-portrait", tone: "soft" },
  ...
  kawaii: [
    ...
    { id: "kawaii-star-portrait", kind: "star", x: 100, y: 24, size: 14, rotate: 12, zone: "portrait-edge", layer: "over-portrait", tone: "glossy" },
    { id: "kawaii-butterfly-right", kind: "butterfly", x: 95, y: 28, size: 10, rotate: 8, zone: "portrait-edge", layer: "over-portrait" },
  ...
  "monochrome-cute": [
    ...
    { id: "monochrome-cute-star-portrait", kind: "star", x: 100, y: 24, size: 14, rotate: 14, zone: "portrait-edge", layer: "over-portrait", tone: "black-chrome" },
    { id: "monochrome-cute-cat-right", kind: "cat", x: 95, y: 28, size: 10, rotate: 8, zone: "portrait-edge", layer: "over-portrait" },
